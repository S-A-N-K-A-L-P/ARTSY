...
export const StorefrontFooterDesktop = () => (
    <footer className="px-20 py-20 border-t border-white/5 grid grid-cols-4 gap-20">
       <div className="col-span-2 space-y-8">
          <h2 className="text-3xl font-bold tracking-tighter italic">Astal Creator</h2>
       ...
       <div className="space-y-6 text-right">
          <h4 className="text-[10px] font-bold uppercase tracking-widest opacity-20">© 2026 Astal</h4>
