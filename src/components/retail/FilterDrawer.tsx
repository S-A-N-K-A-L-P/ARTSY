      ...
      {isOpen && (
        <div className="fixed inset-0 z-[150] flex items-end justify-center">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-lg bg-card/80 backdrop-blur-3xl rounded-t-[40px] p-10 z-10 shadow-[0_-20px_80px_rgba(0,0,0,0.1)]"
          >
            <div className="flex items-center justify-between mb-12">
               <div>
                  <h3 className="text-2xl font-black text-text tracking-tighter">Filter Archetypes</h3>
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-text-muted mt-1">Refine your manifestation</p>
               </div>
